...
Geocode.setApiKey("AIzaSyB9XUiwHq5ijDnEX1FsgVcz3vLHgr2YQPk");
...
class CustomPlacesAutoComplete extends React.Component {
    ...
    render() {
        var { defaultPosition, onChange, ...restProps } = this.props;
        ...
        return (
            <React.Fragment>
                ...
                <Button icon="environment" onClick={this.open}><IntlMessages id="global.choose-location"></IntlMessages></Button>

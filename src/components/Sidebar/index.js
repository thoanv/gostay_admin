			...
			<Fragment>
				...
				>
					<div className={classNames("rct-sidebar-content", { "sidebar-overlay-dark": isDarkSidenav, 'sidebar-overlay-light': !isDarkSidenav })}>
						<div className="site-logo" style={{ backgroundColor: "#012348" }}>
							<Link to="/" className="logo-mini">
								<img src={require("Assets/img/logo.png")} alt="site logo" style={{ height: "35px" }} />
							</Link>
						...
						<div className="rct-sidebar-wrap" style={{ backgroundColor: "#003266" }}>
							<Scrollbars

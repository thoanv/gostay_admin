...
import { _addUtilRoom, _getAllUtilRoom, _deleteUtilRoom } from "../../../actions/UtiliesRoomAction";
import AvatarInTable from "../../../components/AvatarInTable";
import TableActionBar from "../../../components/TableActionBar";
import AddRoom_util from "./AddRoomUtilities";
...
class UtilitiesRoom extends Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
    ...
    onSave =  (data, id) => {
        this.onClose();
        this.props._addRoomUtilities(data);
      };
...
const mapStateToProps = (state) => {
    return {
        list: state.utilitiesRoom.list,
    };
};

const mapDispatchToProps = (dispatch) => {
    return {
        _getAllUtilRoom: () => dispatch(_getAllUtilRoom({ paging: 0 })),
        _addRoomUtilities: (data) => dispatch(_addUtilRoom(data)),
        _onDelete: (data) => dispatch(_deleteUtilRoom(data))
    };
};

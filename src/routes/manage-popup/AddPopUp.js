    ...
    this.props.form
      .validateFields((err, values) => {
        if (!err) {
          ...
          if(this.state.pictureAsFile) {
            const circleFile = this.blobToFile(this.state.blobRound, `round_image_${new Date().getTime()}.png`);
            formData.append("img_circle", circleFile);
          }
          if(this.state.pictureSqrAsFile) {
            const squareFile = this.blobToFile(this.state.blobRect, `rect_image_${new Date().getTime()}.png`);
            formData.append("img_square", squareFile);
          }

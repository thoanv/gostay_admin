...
import OrderDetails from "./VoucherDetails";
import { PayMethod } from "../../../components/PayMethod";
import { ApproveProofModal } from "../../../components/ApproveProofModal";
import {confirmVoucherProofOfPayment, confirmProofOfPayment, getAllOrderVoucher} from '../../../actions/OrderActions';
...
class Voucher extends Component {
    ...
    async componentDidMount() {
        try {
            await this.props.getAllOrderVoucher(this.state.filter);
...
const mapDispatchToProps = (dispatch) => {
    return {
        getAllOrderVoucher: (filter) => dispatch(getAllOrderVoucher(filter)),
        ...
        confirmProofOfPayment: (id, data) => dispatch(confirmVoucherProofOfPayment(id, data))
    };
};

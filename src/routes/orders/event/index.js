...
import OrderDetails from "./EventDetails";
import { PayMethod } from "../../../components/PayMethod";
import { ApproveProofModal } from "../../../components/ApproveProofModal";
import {confirmEventProofOfPayment, confirmProofOfPayment, getAllOrderEvent} from '../../../actions/OrderActions';
...
class Event extends Component {
    ...
    async componentDidMount() {
        try {
            await this.props.getAllOrderEvent(this.state.filter);
...
const mapDispatchToProps = (dispatch) => {
    return {
        getAllOrderEvent: (filter) => dispatch(getAllOrderEvent(filter)),
        ...
        confirmProofOfPayment: (id, data) => dispatch(confirmEventProofOfPayment(id, data))
    };
};

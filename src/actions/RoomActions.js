...
export const getAllItems = (filter = {}) => (dispatch) => {
  return new Promise((resolve, reject) => {
    api
      ...
      .then((res) => {
        dispatch({ type: GET_ALL_ROOM, payload: res.data.data });
        resolve(res.data);
      })
      .catch((error) => {
...
export const getItem = (id) => (dispatch) => {
  return new Promise((resolve, reject) => {
    api
      .get(`/room/load/${id}`, id)
      .then((res) => {
        dispatch({ type: GET_A_ROOM, payload: res.data.data });
        resolve(res.data);
      })
      .catch((error) => {
        console.log(error.response);
...
export const createItem = (data) => (dispatch) => {
  return new Promise((resolve, reject) => {
    api
      .post("/room/save", data)
      .then((res) => {
        dispatch({ type: ADD_A_ROOM, payload: res.data.data });
...
export const deleteItem = (ids) => (dispatch) => {
  return new Promise((resolve, reject) => {
    api
      .delete("/room/delete", { data: ids })
      .then((res) => {
        dispatch({ type: DELETE_ROOM, payload: res.data.data });
